...
public class fourth_question extends AppCompatActivity {
    ...
    public void onClickRadioH(View view){
        boolean checked = ((RadioButton) view).isChecked();
        String getName = "";
        if(view.getId() == R.id.read && checked)
        {
            getName = "Reading";
            main.answerValues[3] = getName;
        }else if(view.getId() == R.id.lifting && checked)
        {
            getName = "Lifting Weights";
            main.answerValues[3] = getName;
        }else{
            getName = "Hiking";
            main.answerValues[3] = getName;
    ...
    public void onClickHobbyNextButton(View view){
        toQuestion5 = findViewById(R.id.next);
        Intent intentNext = new Intent(this, fifth_question.class);
        intentNext.putExtra("addValue", main.answerValues);
        startActivity(intentNext);
    }

    public void onClickHobbyPrevButton(View view){
    ...
    public void onSubmitHobby(View view){
        if((!main.answerValues[0].isEmpty()) && (!main.answerValues[1].isEmpty()) && (!main.answerValues[2].isEmpty()) &&
            ...
            AlertDialog alertDialog = new AlertDialog.Builder(fourth_question.this).create();
            ...
            alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Reset",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            backToStart = findViewById(R.id.buttonBegin);
                            Intent intentRestart = new Intent(fourth_question.this, QuizActivity.class);
                            startActivity(intentRestart);
                        }
                    });
            alertDialog.show();
